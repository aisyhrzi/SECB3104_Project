            ...
            <section class="service-section">
                ...
                <div class="service-section-header">
                    <div class="request-volunteer-form">
                        ...
                        $sql = "SELECT ayamas_food, ayamas_quantity, ayamas_expiry FROM ayamas_request ORDER BY id DESC LIMIT 1";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            // Fetch the data
                            $row = $result->fetch_assoc();
                            $ayamasFood = $row['ayamas_food'];
                            $ayamasQuantity = $row['ayamas_quantity'];
                            $ayamasExpiry = $row['ayamas_expiry'];
                        } else {
